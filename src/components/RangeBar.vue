<template>
  <div class="rangebar">
    <input type="range" :step="step" min="1" max="200" v-model="selectedValue" class="slider" />
    <input type="number" min="1" max="200" v-model.number="selectedValue" class="number-input" />
  </div>
</template>
